    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (playAgain)
            {
                ...
                {
                    Console.WriteLine($"The dealer reveals {dealerHand.Cards[0].CardDisplay()} and {dealerHand.Cards[1].CardDisplay()}");
                ...
                //               game loop ends here, need to clear out deck, player hand, and dealer hand
                Console.WriteLine("Play again? Type (y) to play or anything else to quit");
                var decideToPlayAgain = Console.ReadLine();
                if (decideToPlayAgain != "y")
                {
                    playAgain = false;
                }
                fullDeck.Clear();
                player1Hand.Cards.Clear();
